    ...
    return (
        <div className={styles.main_div}>
            ...
            <div className={styles.total}>
                ...
                <div className={styles.currency}><CurrencyRupeeIcon fontSize="20" style={{ marginTop: "3px" }} /> <span>0</span></div>

            </div>
            <hr className={styles.horizontal} />
            <div className={styles.total_price}>
                <h3>TOTAL AMOUNT</h3>
                <div className={styles.currency_total}><CurrencyRupeeIcon fontSize="20" style={{ marginTop: "4px" }} /> <h3>0</h3></div>
            </div>

    ...
    <div className={styles.otp_body}>
      ...
      <div className={styles.otp_parentDiv}>
        ...
        <div>
          ...
          <div className={styles.otp_input_box}>
            <input
              ...
              onChange={(e) => {
                ...
                if (e.currentTarget.value !== "") ref2.current.focus();
              }}
            />
            <input
              type="text"
              ...
              onChange={(e) => {
                ...
                if (e.currentTarget.value !== "") ref3.current.focus();
              }}
            />
            <input
              type="text"
              ...
              onChange={(e) => {
                ...
                if (e.currentTarget.value !== "") ref4.current.focus();
              }}
            />
            <input
              type="text"
          ...
          <p className={styles.otp_para}>
            {count >= 10 ? (
              <span>
                Resend OTP in : <b style={{ color: "black" }}>00:{count}</b>
              </span>
            ) : count >= 0 ? (
              <span>
                Resend OTP in : <b style={{ color: "black" }}>00:0{count}</b>
              </span>
            ) : (
              <b className={styles.otp_bold} onClick={resend}>
                RESEND OTP
              </b>
            )}
          </p>
          <p className={styles.otp_para1}>
            Log in using{" "}
            <b
              className={styles.otp_bold}
          ...
          <p className={styles.otp_para1}>
            ...
            <b className={styles.otp_bold}>Get help</b>
          </p>
        </div>
      </div>
    </div>

...
export const WomenKurti = () => {
  ...
  const discount = (value) => {
    let list = kurti.filter((item) => item.price.discount >= value);
    console.log(list);
    setKurti(list);
  };
  const sorting = (val) => {
    if (val === "high") {
      kurti.sort((a, b) => b.customer_rating - a.customer_rating);
      setSort("high");
    } else {
      kurti.sort((a, b) => a.customer_rating - b.customer_rating);
